    ...
    <div class="nav-inner">
        ...
        <div class="nav-links" id="nav-links">
            ...
            <a href="/techhive/cart.php"           class="nav-link" style="display:flex;align-items:center;gap:5px;">
                Cart
                <span id="cart-count" style="display:none;background:#6366f1;color:#fff;font-size:0.68rem;font-weight:700;border-radius:99px;min-width:16px;height:16px;padding:0 4px;align-items:center;justify-content:center;line-height:1;">0</span>
            </a>
            ...
            <?php if ($isLoggedIn): ?>
                ...
                <?php endif; ?>
                <a href="/techhive/dashboard.php" class="nav-link" style="color: #818cf8;"><?= $username ?></a>
        ...
        <button id="menu-btn" onclick="document.getElementById('nav-links').classList.toggle('open')"
            style="background:none;border:none;cursor:pointer;color:#71717a;padding:4px;align-items:center;justify-content:center;">
