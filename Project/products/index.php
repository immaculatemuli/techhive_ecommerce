...
.pill-on  { background:#1e3a8a; color:#fff; border-color:#1e3a8a; }
...
<div style="max-width:1160px;margin:0 auto;padding:0 40px;">
    ...
    <?php if (empty($products)): ?>
        <div style="text-align:center;padding:80px 0;">
            ...
            <a href="index.php" style="font-weight:700;color:#1e3a8a;text-decoration:none;border-bottom:2px solid #1e3a8a;padding-bottom:1px;">
                View all →
            </a>
        </div>
    <?php else: ?>
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:20px;" id="product-grid">
            ...
            <div class="p-card product-card" data-name="<?= htmlspecialchars(strtolower($p['name'])) ?>">
                ...
                <!-- Image -->
                <a href="view.php?id=<?= $p['id'] ?>" class="p-img-wrap" style="display:block;text-decoration:none;">
                    <?php if ($img): ?>
                    ...
                    <?php if ($p['stock'] === 0): ?>
                        <div style="position:absolute;inset:0;background:rgba(0,0,0,0.55);
                                    display:flex;align-items:center;justify-content:center;">
                            <span style="background:#dc2626;color:#fff;font-size:0.75rem;font-weight:700;
                                         padding:6px 14px;border-radius:99px;letter-spacing:0.04em;text-transform:uppercase;">
                                Out of Stock
                            </span>
                        </div>
                ...
                <div class="p-body">
                    <div style="flex:1;">
                        <a href="view.php?id=<?= $p['id'] ?>" style="text-decoration:none;">
